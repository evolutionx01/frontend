...
export class MembershipComponent implements OnInit {
  ...
  public buildRegisterForm(){
    this.registerForm = this.formBuilder.group({
      ...
      NRIC_new: [null, Validators.required],
      NRIC_old: [null],
      marital_status: ['', Validators.required],
      gender: ['', Validators.required],
      age: [0, Validators.required],
      mobile: [0, Validators.required],
      whatsapp: [0, Validators.required],
      ...
      income_gross: [0, Validators.required],
      income_net: [0, Validators.required],
      income_other: [0],
      monthly_expense: [0, Validators.required],
      adequate_income: [0, Validators.required],
